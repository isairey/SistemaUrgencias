            ...
            <div class="card card-outline card-primary">
                ...
                <div class="card-body">
                    ...
                    <script>
                        ...
                        // 📡 Escucha los tres canales emitidos por el evento
                        window.Echo.channel('panel-pacientes')
                            .listen('PatientStatusUpdated', actualizarVista);

                        window.Echo.channel('categoria.esi-3') // ← ajusta según la categoría del panel
                            .listen('PatientStatusUpdated', actualizarVista);

                        window.Echo.channel('estado.en-espera-de-atencion') // ← ajusta según el estado del panel
                            .listen('PatientStatusUpdated', actualizarVista);
                    </script>
                    {{-- DataTable --}}
                    <script>
