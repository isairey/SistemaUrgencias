...
<body class="index-page">
  ...
  <!--<header id="header" class="header d-flex align-items-center fixed-top">
    <div class="header-container container-fluid container-xl position-relative d-flex align-items-center justify-content-between">
      ...
      <a href="/" class="logo d-flex align-items-center me-auto me-xl-0">
        ...
        <h1 class="sitename">Félix Bulnes Cerda</h1>
      </a>
  ...
  <main class="main">
    ...
    <!-- Hero Section -->
    <section id="hero" class="hero section dark-background d-flex align-items-center justify-content-center position-relative vh-100 overflow-hidden">
      <div class="container-fluid p-0">
        <div class="hero-wrapper">
          <div class="hero-image">
            <img src="assets/img/gallery/felix-bulnes.png" alt="Advanced Healthcare"  class="position-absolute top-0 start-0 w-100 h-100 object-fit-cover z-n1">
          </div>
          ...
          <div class="hero-content">
            <div class="container">
              <div class="d-flex align-items-center justify-content-start flex-wrap gap-5">
                <div>
                  <h1 style="font-size: 3rem; text-uppercase fw-bold">Estado de ocupación de Urgencia Adulto</h1>
                  <p class="fs-3 mb-0">Hospital Clínico Félix Bulnes Cerda</p>
                </div>
                <div>
                  <a href="{{ url('login') }}" class="btn btn-outline-light btn-lg rounded-pill px-5 py-3">
