...
'broadcasting.connections.pusher.app_id','broadcasting.connections.pusher.options.cluster','broadcasting.connections.pusher.options.useTLS','broadcasting.connections.pusher.options.host','broadcasting.connections.pusher.options.port',
'broadcasting.connections.pusher.options.scheme','broadcasting.connections.pusher.options.encrypted','broadcasting.connections.ably.driver','broadcasting.connections.ably.key','broadcasting.connections.log.driver',
...
'password.request','password.email','password.reset','password.update','password.confirm','home','admin.index','admin.usuarios.index','admin.usuarios.create',
'admin.usuarios.store','admin.usuarios.show','admin.usuarios.edit','admin.usuarios.update','admin.usuarios.destroy',
'admin.admin_urgencias.index','admin.admin_urgencias.create','admin.admin_urgencias.store','admin.admin_urgencias.show','admin.admin_urgencias.edit',
'admin.admin_urgencias.update','admin.admin_urgencias.destroy','admin.admin_enfermeros.index','admin.admin_enfermeros.create','admin.admin_enfermeros.store',
'admin.admin_enfermeros.show','admin.admin_enfermeros.edit','admin.admin_enfermeros.update','admin.admin_enfermeros.destroy','admin.admisiones.index',
'admin.admisiones.create','admin.admisiones.store','admin.admisiones.show','admin.admisiones.edit','admin.admisiones.update',
'admin.admisiones.destroy','admin.enfermeros.index','admin.enfermeros.create','admin.enfermeros.store','admin.enfermeros.show',
'admin.enfermeros.edit','admin.enfermeros.update','admin.enfermeros.destroy','admin.pacientes.index','admin.pacientes.create',
'admin.pacientes.store','admin.pacientes.show','admin.pacientes.edit','admin.pacientes.update','admin.pacientes.destroy',
'admin.atenciones.create','admin.atenciones.store','admin.pacientes.atencionRapida','admin.pacientes.condition','admin.pacientes.updateCategory',
'admin.panel.index',);
        registerArgumentsSet('views', 
'admin.admin_enfermeros.create','admin.admin_enfermeros.index','admin.admin_urgencias.create','admin.admin_urgencias.index','admin.admisiones.create',
'admin.admisiones.index','admin.atenciones.create','admin.condition','admin.enfermeros.create','admin.enfermeros.index',
'admin.index','admin.pacientes.create','admin.pacientes.edit','admin.pacientes.index','admin.pacientes.show',
'admin.panel','admin.usuarios.create','admin.usuarios.index','auth.login','auth.passwords.confirm',
'auth.passwords.email','auth.passwords.reset','auth.register','auth.verify','home',
'index','layouts.admin','layouts.app','welcome','laravel-exceptions-renderer::components.card',
...
'validation.uuid','validation.custom.attribute-name.rule-name','passwords.password','validation.password',);
...
'SESSION_PATH','SESSION_DOMAIN','MAIL_MAILER','MAIL_HOST','MAIL_PORT',
'MAIL_USERNAME','MAIL_PASSWORD','MAIL_ENCRYPTION','MAIL_FROM_ADDRESS','MAIL_FROM_NAME',
'BROADCAST_DRIVER','PUSHER_APP_ID','PUSHER_APP_KEY','PUSHER_APP_SECRET','CACHE_DRIVER',
'QUEUE_CONNECTION','SESSION_DRIVER','REDIS_HOST','REDIS_PASSWORD','REDIS_PORT',
'PUSHER_APP_HOST','PUSHER_APP_PORT','PUSHER_SCHEME','PUSHER_APP_CLUSTER','VITE_PUSHER_APP_KEY',
'VITE_PUSHER_APP_CLUSTER','VITE_PUSHER_HOST','VITE_PUSHER_PORT','VITE_PUSHER_USE_TLS','VITE_APP_NAME',
'VITE_HOST',);
